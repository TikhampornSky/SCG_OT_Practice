              ...
              <div class="container-fluid">
                <div class="row pt-5 mt-5">
                  <div class="col-12 pt-5 text-center">
                    ...
                    <h5 class="text-success font-weight-light mt-4">ระบบได้รับข้อมูลของท่านเรียบร้อยแล้ว</h5><br><br>
                      <a class="btn btn-primary col" href="../../index.html"><i class="ti-home mr-2"></i>กลับหน้าหลัก</a><br><br>
                      <a class="btn btn-primary col" href="loginLine1.html"><i class="ti-home mr-2"></i>ดูสถานะ</a>
