...
if (isset($_POST["normal"])) {
    header( "Location: booking.php?ot=normal");
}

if (isset($_POST["lunch"])) {
    header( "Location: booking.php?ot=lunch");
}
                        ...
                        <form method="POST">
                            <div class="card-body ">
                                <div class="" style="text-align: center; ">
                                  <b class="card-title text-dark">เลือกรูปแบบการขอ OT </b>
                                </div>
                            </div><br>
                            <div class="row">
                                <div class="col-md-12  stretch-card">
                                      <div class="card">
                                            <button name="normal" class="col-md-12 btn text-light" style="background:#2980B9; min-height: calc(10vh); text-align: center; font-size: 150%;">OT ปกติ</button>
                                      </div>
                                </div>
                             </div>
                             <br><br>
                             <div class="row">
                                <div class="col-md-12  stretch-card">
                                      <div class="card">
                                            <button name="lunch" class="col-md-12 btn text-light" style="background:#16A085; min-height: calc(10vh); text-align: center; font-size: 150%;">OT พักเที่ยง</button>
                                      </div>
                                </div>
                             </div>
                         </form>
