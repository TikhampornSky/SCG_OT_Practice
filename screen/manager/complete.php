              ...
              <div class="container-fluid">
                <div class="row pt-5 mt-5">
                  <div class="col-12 pt-5 text-center">
                    ...
                    <h4 class="text-success font-weight-light mt-5">ระบบได้รับข้อมูลของท่านเรียนร้อยแล้ว </h4>
                      <a class="btn btn-primary" href="index.html"><i class="ti-home mr-2"></i>ไปที่รายการรอดำเนินการ</a>
                    </h4>
                  </div>
                </div>
                <div class="row">
