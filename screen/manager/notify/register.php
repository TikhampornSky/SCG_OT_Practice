...
if (isset($_POST["login"])) {
    $sql = mysqli_query($con, "UPDATE `approver` SET `line_id`='$line_id' WHERE `approver_id` = '$user_id'");
    // echo "UPDATE `approver` SET `line_id`='$line_id' WHERE `approver_id` = '$user_id'";
    if (sql){
        // echo ("UPDATE `approver` SET `manager_name`='$line_name', `line_id`='$line_id' WHERE `approver_id` = '$user_id'");
        header("Location: ../../employee/line/addLine.php");
    }
}
